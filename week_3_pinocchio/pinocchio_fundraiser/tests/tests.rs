...
use pinocchio_fundraiser::instructions::Initialize;
use pinocchio_fundraiser::states::{to_bytes, MyState};
use solana_sdk::rent::Rent;
use solana_sdk::sysvar::Sysvar;

pub const PROGRAM: Pubkey = pubkey!("AYQEqZMiyxTfz9m9fcoQuPu3SA6wtbD2XCjEMMgfiXJH");

pub const RENT: Pubkey = pubkey!("SysvarRent111111111111111111111111111111111");

pub const PAYER: Pubkey = pubkey!("6kBeV6jyaESAM397ZFUBch2RHH5Xkev1q8sX7S3dd1h7");

pub fn mollusk() -> Mollusk {
    let mollusk = Mollusk::new(&PROGRAM, "target/deploy/pinocchio_fundraiser");
    mollusk
}
