...
pub fn process_instruction(
    ...
    match ProgramInstruction::try_from(disc)? {
        ...
        ProgramInstruction::Checker => instructions::process_checker(accounts, data),
        ProgramInstruction::Refund => instructions::process_refund(accounts, data),
    }
    Ok(())
}